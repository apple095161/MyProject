<template>
  <div>
    <div class="side-nav" id="show-side-navigation1">
      ...
      <!-- <div class="search">
        <input type="text" placeholder="Type here" /><i
          class="fa fa-search"
        ></i>
      </div> -->
      <ul class="categories">
        <li>
          <a @click.prevent style="cursor: pointer">商品管理</a>
          <ul class="side-nav-dropdown">
            <li>
              <router-link :to="{ name: 'dashboardOrder' }"
                >訂單管理</router-link
              >
            </li>
            <li>
              <router-link :to="{ name: 'produtList' }">所有商品</router-link>
            </li>
            <li>
              <router-link :to="{ name: 'addType' }">新增類別</router-link>
            </li>
          </ul>
        </li>
        <p>Example:</p>
